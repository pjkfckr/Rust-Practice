...
//    프로그램을 컴파일 하고 실행하려면 `ProgramError` 열거형을 수정해야한다
//  * The output should display a menu error followed by a math error then running.
//    출력에는 메뉴 오류와 math 오륲가 차례로 표시되어야 한다.
//  Notes:
